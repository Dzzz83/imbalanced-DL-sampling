...
def plot_multi_comparison(source_paths, output_dir):
    ...
    ax.set_title('Imbalanced cifar10 None and Lava selection ratios', fontsize=16, fontweight='bold')
    ax.set_xticks(x)
    ...
    plt.tight_layout()
    save_path = os.path.join(output_dir, 'Imbalanced cifar10 None and Lava selection ratios.png')
...
if __name__ == "__main__":
    ...
    folders_to_compare = [
        "../experiments/cifar10_exp0.01",
        "../experiments/cifar10_exp0.01/lava"
    ]
    
    results_output = "cifar10_exp0.01/comparisons" 
